...
# LOSS_ONE CFG
CFG.LOSS_ONE = CN()
CFG.LOSS_ONE.CE_WEIGHT = 1.0
CFG.LOSS_ONE.ALPHA = 1.0
CFG.LOSS_ONE.GAMMA = 4.0
CFG.LOSS_ONE.T = 4.0

#LOSS_TWO CFG
CFG.LOSS_TWO = CN()
CFG.LOSS_TWO.CE_WEIGHT = 1.0
CFG.LOSS_TWO.BETA = 8.0
#CFG.LOSS_TWO.GAMMA = 4.0
CFG.LOSS_TWO.T = 4.0
CFG.LOSS_TWO.WARMUP = 20

# NKD (Knowledge Distillation via CE) CFG
CFG.NKD = CN()
